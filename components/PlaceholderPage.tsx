...
export function PlaceholderPage({ pageKey }: PlaceholderPageProps) {
  ...
  return (
    <main className="mx-auto min-h-screen max-w-md px-5 py-10 md:max-w-3xl md:px-8">
      <div className="rounded-[28px] border border-beige/60 bg-cream/90 p-7 shadow-soft md:p-10">
